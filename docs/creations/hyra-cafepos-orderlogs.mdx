...
- <Icon name="check" color="green" /> You must have an active Hyra Instance.
...
<NumberedList>
  ...
  <div>
    Create a new <GradientText animated>Script</GradientText> in <GradientText animated>ServerScriptService</GradientText>. Name it anything.
  </div>
  <div>
  ...
  <div>
    Create a <GradientText animated>ModuleScript</GradientText> in your Addons folder in your CafePOS instance. You can name it Order Logging or anything else you want it to be.
    <ul>
